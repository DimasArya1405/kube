...
<head>
    ...
    <title>Register Pendamping - KUBE</title>
        ...
        <div class="flex flex-col md:flex-row w-full max-w-[1000px] bg-white rounded-xl overflow-hidden shadow-xl">
            ...
            <div class="relative w-full md:w-5/12 bg-gradient-to-br from-slate-100 to-slate-200 p-10 flex flex-col justify-center overflow-hidden border-b md:border-b-0 border-gray-200">
                ...
                <div class="relative z-10">
                    <h2 class="text-3xl font-extrabold text-slate-800 leading-tight">
                        Daftar <span class="text-cyan-600">Pendamping</span>
                    </h2>
                    <p class="text-xs text-slate-400 mt-1 font-medium">
                        Lengkapi data untuk akses monitoring dan bimbingan lapangan.
                    </p>
                    <div class="w-12 h-1 bg-cyan-500 rounded-full mt-4 mb-6"></div>
                    ...
                    <div class="grid grid-cols-2 gap-4 max-w-sm">
                        <div class="flex flex-col gap-2 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-slate-200/50 shadow-sm">
                            <div class="w-8 h-8 bg-cyan-100 rounded-lg flex items-center justify-center">
                                <i data-lucide="user-check" class="w-4 h-4 text-cyan-600"></i>
                            </div>
                        ...
                        <div class="flex flex-col gap-2 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-slate-200/50 shadow-sm">
                            ...
                            <div><p class="text-xs font-bold text-slate-700">Akses Lapangan</p></div>
                        </div>
                        <div class="flex flex-col gap-2 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-slate-200/50 shadow-sm">
            ...
            <div class="w-full md:w-7/12 p-8 md:p-12 flex flex-col justify-center">
                <div class="text-center mb-6">
                    <h3 class="text-2xl font-semibold text-gray-800">Daftar Akun Pendamping</h3>
                    <p class="text-gray-500 mt-1 text-sm">Lengkapi data pendaftaran tim pendamping</p>
                </div>
                ...
                <form method="POST" action="{{ route('register.pendamping.store') }}" class="space-y-3">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama" id="inputNama" placeholder="Nama Lengkap" required
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none text-sm">
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="inputPassword" placeholder="Password" required
                                class="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none text-sm">
                            <button type="button" onclick="togglePassword()" 
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-cyan-600 transition-colors flex items-center justify-center">
                        ...
                        <div class="relative md:col-span-2">
                            ...
                            <textarea name="alamat" placeholder="Alamat Domisili" required
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none text-sm h-20 resize-none"></textarea>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <select name="id_kecamatan" id="selectKecamatan" required 
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none bg-white text-sm text-gray-600 appearance-none">
                        ...
                        <div class="relative">
                            ...
                            <select name="id_desa_kelurahan" id="selectDesa" required disabled
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none bg-gray-50 text-sm text-gray-600 appearance-none disabled:bg-gray-100 disabled:cursor-not-allowed">
                    ...
                    <button type="submit" 
                        class="w-full bg-cyan-600 hover:bg-cyan-700 text-white font-medium py-3 rounded-lg transition-colors shadow-lg shadow-cyan-200 mt-2 flex justify-center items-center gap-2">
                ...
                <div class="mt-4 text-center text-sm text-gray-600">
                    Sudah punya akun? 
                    <a href="/login" class="text-cyan-600 hover:underline font-medium">Masuk</a>
                </div>
            </div>
        </div>
    </div>
