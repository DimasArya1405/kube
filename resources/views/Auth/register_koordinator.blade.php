...
<head>
    ...
    <title>Register Koordinator - KUBE</title>
        ...
        <div class="flex flex-col md:flex-row w-full max-w-[1000px] bg-white rounded-xl overflow-hidden shadow-xl">
            ...
            <div class="w-full md:w-7/12 p-8 md:p-12 flex flex-col justify-center">
                <div class="text-center mb-6">
                    <h3 class="text-2xl font-semibold text-gray-800">Daftar Akun Koordinator</h3>
                    <p class="text-gray-500 mt-1 text-sm">Lengkapi data pendaftaran tingkat koordinator</p>
                </div>
                ...
                <form method="POST" action="{{ route('register.koordinator.store') }}" class="space-y-3">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama" id="inputNama" placeholder="Nama Lengkap" required
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none text-sm">
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="inputPassword" placeholder="Password" required
                                class="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none text-sm">
                            <button type="button" onclick="togglePassword()" 
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-amber-600 transition-colors flex items-center justify-center">
                        ...
                        <div class="relative md:col-span-2">
                            ...
                            <textarea name="alamat" placeholder="Alamat Domisili" required
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none text-sm h-20 resize-none"></textarea>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <select name="id_kecamatan" id="selectKecamatan" required 
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none bg-white text-sm text-gray-600 appearance-none">
                        ...
                        <div class="relative">
                            ...
                            <select name="id_desa_kelurahan" id="selectDesa" required disabled
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none bg-gray-50 text-sm text-gray-600 appearance-none disabled:bg-gray-100 disabled:cursor-not-allowed">
                    ...
                    <button type="submit" 
                        class="w-full bg-amber-600 hover:bg-amber-700 text-white font-medium py-3 rounded-lg transition-colors shadow-lg shadow-amber-200 mt-2 flex justify-center items-center gap-2">
                        <i data-lucide="user-plus" class="w-5 h-5"></i>
                        Daftar Sebagai Koordinator
                    </button>
                </form>

                <div class="mt-4 text-center text-sm text-gray-600">
                    Sudah punya akun? 
                    <a href="/login" class="text-amber-600 hover:underline font-medium">Masuk</a>
                </div>
            </div>
        </div>
    </div>
