...
<div class="mb-8 flex flex-col md:flex-row md:items-center gap-4">
    {{-- <button onclick="window.history.back()" class="w-11 h-11 bg-white border border-gray-200 shadow-sm rounded-xl flex items-center justify-center text-gray-500 hover:text-[#48CAE4] hover:bg-[#48CAE4]/10 transition-all" title="Kembali">
