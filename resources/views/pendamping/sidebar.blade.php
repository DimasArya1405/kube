<nav class="flex-1 px-4 mt-4 space-y-2 overflow-y-auto custom-scrollbar">
    ...
    <div class="relative">
        ...
        <div id="monevMenu" class="hidden flex flex-col mt-2 ml-4 space-y-1 border-l border-indigo-500/50 pl-4 text-[11px] uppercase tracking-widest font-bold">
            <a href="{{ route('kunjungan.index') }}" class="py-2 px-3 text-indigo-200 hover:text-white">Jadwal Kunjungan Pendamping</a>
        </div>
    </div>

    <!-- Menu Bimbingan Lapangan -->
    <div class="relative">
    ...
    <!-- Menu Analisis Pendamping / Prediksi -->
    <div class="relative">
        <button onclick="toggleDropdown('analisisPendampingMenu', 'analisisPendampingIcon')" class="w-full flex items-center justify-between px-4 py-3 hover:bg-indigo-600 rounded-xl transition-all text-indigo-100 hover:text-white group">
            <div class="flex items-center gap-3">
                ...
                <span class="font-medium text-start text-sm">Analisis Prediksi</span>
            </div>
