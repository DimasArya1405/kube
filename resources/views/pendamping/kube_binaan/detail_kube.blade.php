...
<div class="mb-8 flex flex-col md:flex-row md:items-center gap-4">
    ...
    <div>
        <h2 class="text-3xl font-bold text-gray-800">Manajemen Detail KUBE: <span class="text-blue-600 uppercase">{{ $kube->nama_kube }}</span></h2>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="space-y-4">
                <div class="flex items-center p-3.5 bg-blue-50 rounded-xl border border-blue-100">
                    ...
                    <div>
                        <p class="text-[11px] text-blue-500 font-bold uppercase tracking-wider">Pendamping</p>
            ...
            <div class="p-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    <div class="relative w-full sm:w-64">
                        ...
                        <input type="text" class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm bg-white transition-all placeholder:text-gray-400" placeholder="Cari nama Anggota...">
                    </div>
                    <button onclick="toggleModal('tambahAnggotaModal')" class="px-4 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition shadow-sm flex items-center justify-center shrink-0">
                        Tambah Anggota
                    </button>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors bg-white">
                            ...
                            <td class="py-4 px-5 text-center">
                                ...
                                @elseif($jabatan == 'sekretaris')
                                    <span class="bg-blue-100 px-3 py-1 text-xs rounded-md border border-blue-200 text-blue-800 font-semibold">Sekretaris</span>
        ...
        <form action="{{ route('anggota_kube.store') }}" method="POST" class="flex flex-col overflow-hidden flex-1">
            ...
            <div class="p-6 overflow-y-auto flex-1">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">NIK</label>
                        <input type="text" name="nik" maxlength="16" placeholder="16 Digit NIK" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm placeholder:text-gray-400" required>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Nama Anggota</label>
                        <input type="text" name="nama_anggota" placeholder="Nama Sesuai KTP" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm placeholder:text-gray-400" required>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">No. Handphone</label>
                        <input type="text" name="no_hp" maxlength="15" placeholder="08xxxxx" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm placeholder:text-gray-400" required>
                    </div>
                    
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Alamat Lengkap</label>
                        <textarea name="alamat" rows="3" placeholder="Masukkan alamat lengkap domisili..." class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm resize-none placeholder:text-gray-400" required></textarea>
                    </div>
