...
@section('content')
    <div class="mb-8 flex justify-between items-end">
        ...
        <div class="flex justify-end gap-2">
            <a href="{{ route('kadis.alur_bantuan.jenis_bantuan.index') }}"
                            ...
                            <td class="px-6 py-4">
                                @if ($row->status_pencairan == 'menunggu')
                                    <div class="flex gap-2">
                                        <a href="{{ route('kadis.pencairan_bantuan.accept', $row->id_pencairan) }}"
                                        ...
                                        <a href="{{ route('kadis.pencairan_bantuan.reject', $row->id_pencairan) }}"
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($pengajuan_bantuan as $i => $row)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-4">
                                    <form action="{{ route('kadis.pencairan_bantuan.tambah', $row->id_pengajuan_kube) }}"
                                        method="POST"
