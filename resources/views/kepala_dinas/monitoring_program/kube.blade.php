            ...
            <div class="p-6 overflow-y-auto flex-1">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $k->pembagianPendampingAktif->pembagianKoordinator->koordinator->nama_koor ?? 'Belum ada Koordinator' }}" disabled class="w-full border border-gray-200 bg-gray-100 rounded-lg px-4 py-2 text-gray-500 text-sm cursor-not-allowed">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Pendamping</label>
                        <input type="text" value="{{ $k->pembagianPendampingAktif->pendamping->nama_pendamping ?? 'Belum ada Pendamping' }}" disabled class="w-full border border-gray-200 bg-gray-100 rounded-lg px-4 py-2 text-gray-500 text-sm cursor-not-allowed">
                    </div>
