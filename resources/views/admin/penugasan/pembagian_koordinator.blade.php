...
<div class="flex items-center gap-3 mb-4 w-full">
    ...
    <select id="filterTahun"
        class="border px-3 py-2 rounded-lg text-sm whitespace-nowrap">
    ...
    <a href="{{ route('pembagian_koordinator.exportPDF') }}"
        class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg whitespace-nowrap">
        Ekspor PDF
    </a>
                        ...
                        <tr class="border-t hover:bg-gray-50 searchable-row"
                            ...
                            <td class="px-4 py-3">
                                 <div class="flex items-center justify-center gap-2">
                                    {{-- EDIT --}}
                                    <button
                                            class="w-9 h-9 flex items-center justify-center rounded-lg text-yellow-500 hover:bg-yellow-50 transition-colors btn-edit"
                                    ...
                                    <form action="{{ route('pembagian_koordinator.destroy', $row->id_pembagian_koor) }}" method="POST"
                                          onsubmit="return confirm('Yakin hapus data ini?')"class="inline-block m-0">
                                        @csrf
                                        @method('DELETE')
                                         <button
                                            type="submit"
                                                class="w-9 h-9 flex items-center justify-center rounded-lg text-red-500 hover:bg-red-50 transition-colors"
                                                title="Hapus">
