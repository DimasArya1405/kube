        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="space-y-3.5">
                ...
                <div class="flex justify-between items-center border-b border-gray-50 pb-2.5">
                    ...
                    @else
                        <span class="bg-red-100 border border-red-200 text-red-700 px-2.5 py-1 rounded-md text-xs font-bold">Tidak Aktif</span>
                    @endif
                </div>
            ...
            <div class="p-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    <div class="relative w-full sm:w-64">
                        ...
                        <input type="text" class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm bg-white transition-all placeholder:text-gray-400" placeholder="Cari anggota...">
                    </div>
