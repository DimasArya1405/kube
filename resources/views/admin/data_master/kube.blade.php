        ...
        <form action="{{ route('kube.update', $k->id_kube) }}" method="POST" class="flex flex-col overflow-hidden flex-1">
            ...
            <div class="p-6 overflow-y-auto flex-1">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Koordinator Wilayah</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Pendamping KUBE</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Keterangan Lanjutan</label>
                        <textarea name="keterangan" rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm resize-none" placeholder="Tambahkan keterangan...">{{ $k->keterangan }}</textarea>
                    </div>
